    ...
    <div className="property-detail-page">
      ...
      <div className="property-detail-container">
        ...
        <div className="property-left-section">
          ...
          <ScrollReveal variant="fade-right" delay={0} duration={0.7}>
        ...
        <div className="property-right-section">
          ...
          <ScrollReveal variant="fade-left" delay={0} duration={0.7}>
        ...
        {showSchedule && (
          <ScrollReveal variant="scale-up" delay={0} threshold={0.02}>
        ...
        {/* AI Analysis Section */}
        {showAiAnalysis && (
          <ScrollReveal variant="fade-up" delay={0} threshold={0.02}>
