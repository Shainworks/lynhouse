...
class GeminiAnalysisView(APIView):
    """AI property analysis powered by Gemini."""
    ...
    def post(self, request):
        ...
        try:
            ...
            print("Gemini Analysis Exception:", str(e))
...
class GeminiChatAPIView(APIView):
    """General-purpose real estate chatbot powered by Gemini."""

    SYSTEM_CONTEXT = (
        "You are Lyn AI, a friendly and knowledgeable real estate assistant for the Lyn Housing AI platform. "
        "You help users with questions about buying, selling, renting, investing in real estate, market trends, "
        "property valuation, mortgages, and anything related to housing. "
        "Keep answers concise, helpful, and professional. "
        "If a question is completely unrelated to real estate or housing, politely redirect the user back to real estate topics."
    )
    ...
    def post(self, request):
        ...
        try:
            ...
            print("Gemini Chat Exception:", str(e))
            return Response({"error": "Chat failed.", "details": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
